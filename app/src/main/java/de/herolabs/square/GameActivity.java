...
public class GameActivity extends Activity implements OnClickListener, Runnable {
    ...
    private void startRound() {
        ...
        RelativeLayout.LayoutParams chParams =
                (android.widget.RelativeLayout.LayoutParams) character.getLayoutParams();
        chParams.leftMargin = 0;
    ...
    public void onClickRightBtn(View v) {
        ...
        if (player.getPosY() == 0 && player.getPosX() == GameActivity.SIZE - 1) {
            startRound();
        }
    ...
    public void gameOver() {
        ...
        gameover.show();
        final TextView scoreTextView = (TextView) gameover.findViewById(R.id.scoreTextView);
        scoreTextView.setText("Score: " + (Integer.toString(round - 1)));
        final ImageButton replayBtn = (ImageButton) gameover.findViewById(R.id.replayButton);
        final ImageButton homeBtn = (ImageButton) gameover.findViewById(R.id.homeButton);
        ...
        homeBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                gameover.dismiss();
                replayBtn.destroyDrawingCache();
                homeBtn.destroyDrawingCache();
                scoreTextView.destroyDrawingCache();
                finish();
            }
        });
    }
